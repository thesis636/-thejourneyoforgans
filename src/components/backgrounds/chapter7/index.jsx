...
const BackgroundAnimetion = styled.div`
  display: ${(props) => (props.chapter === "7" ? "flex" : "none")};
  width: 100%;
  height: 100%;
  justify-content: center;
  align-items: center;
  animation: backgroundChapter7 ${(props) => props.imgs.data.length - 1}s
    cubic-bezier(1, -1, 0, 2) infinite alternate;

  @keyframes backgroundChapter7 {
    ${(props) =>
      props.imgs.data.map(
